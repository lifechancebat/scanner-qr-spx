    ...
    <div className="flex-1 bg-slate-50 overflow-y-auto pb-24 flex flex-col">
      <header className="bg-slate-50 flex items-center justify-between px-4 h-16 shrink-0">
        <div className="flex items-center gap-4">
          ...
          <h1 className="font-bold text-lg text-slate-900">Đang Đóng Gói</h1>
        </div>
      ...
      <div className="p-6 flex-1 flex flex-col gap-6">
        <div>
          <p className="text-xs font-bold text-red-700 tracking-wider uppercase mb-1">Phiên Hiện Tại</p>
          <h2 className="text-3xl font-black text-slate-900 mb-1">Đơn Hàng</h2>
          <p className="text-sm text-slate-600 break-all font-mono bg-slate-200 p-2 rounded-lg mt-2 inline-block">
            {scannedCode}
          </p>
        </div>

        <div className="grid grid-cols-2 gap-4">
          <div className="bg-white rounded-2xl p-4 shadow-sm border-l-4 border-transparent">
            <p className="text-xs font-bold text-slate-500 tracking-wider uppercase mb-2">Trạng Thái</p>
            <div className="flex items-center gap-2 mt-2">
              <div className="w-2 h-2 rounded-full bg-blue-500 animate-pulse"></div>
              <span className="text-lg font-bold text-slate-900">Đang xử lý</span>
            </div>
          </div>
          <div className="bg-white rounded-2xl p-4 shadow-sm border-l-4 border-amber-500">
            <p className="text-xs font-bold text-slate-500 tracking-wider uppercase mb-2">Thời Gian Còn Lại</p>
        ...
        <div className="bg-blue-50 rounded-2xl p-6 flex flex-col items-center justify-center mt-4 border border-blue-100">
          <Package size={48} className="text-blue-400 mb-4" />
          <p className="text-center text-slate-700 font-medium">
            Vui lòng tiến hành đóng gói đơn hàng. Nhấn "Kết Thúc" khi hoàn thành.
          </p>
        ...
        <div className="flex items-center justify-center gap-2 text-xs font-medium text-slate-500 bg-slate-200/50 px-4 py-2 rounded-full mx-auto w-max">
          {isListening ? (
            <>
              ...
              <span className="text-green-700">Hãy nói "Xong" để kết thúc</span>
            </>
          ) : (
            <>
              <MicOff size={14} />
